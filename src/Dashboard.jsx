        ...
        <div className="w-full p-3 h-28 hidden sm:block sm:h-20 xl:h-32">
          <div
            ...
            <div className="block sm:hidden xl:block pt-3">
              ...
              <animated.div className="text-right text-gray-600 text-xs">
          ...
          <div className="sm:flex-grow flex justify-between">
            <div className="">
              <div className="flex items-center">
                <div className="text-3xl font-bold text-black">Hello David</div>
          ...
          <div className="w-full sm:w-56 mt-4 sm:mt-0 relative">
            ...
            <form action="#" method="POST">
              <input
                ...
                id="company_website"
                className="pl-12 py-2 pr-2 block w-full rounded-lg border-gray-600 bg-card"
                placeholder="search"
              />
            </form>
          </div>
